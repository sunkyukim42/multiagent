...
The offline demo uses local sample documents and claim JSONL files. API keys
are not required. Generated artifacts are ignored by git.
...
Frame the project as an AI/AX engineering demo that adds reliability
infrastructure around domain-specific agent outputs.
...
The demo does not require API keys, does not call live services, does not
modify the live TradingAgents graph, and does not provide financial or
procurement advice.
