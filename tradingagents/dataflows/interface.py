...
#from tradingagents.dataflows import fred_common as mt
from tradingagents.dataflows import fred_common as fred
...
TOOLS_CATEGORIES = {
    ...
    # "shipping_data": {
    #     "description": "Marine AIS / voyage / port calls",
    #     "tools": [
